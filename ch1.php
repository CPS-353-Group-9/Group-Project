	...
	<body>
		...
		<div class="textbook-body">
			...
			<section>
				...
				<p>In every coding language, there are what are called <span class="keywords">data types</span> and a way to store different types of data. The way to store data is with a <span class="keywords">variable</span>. </p>
			</section>
